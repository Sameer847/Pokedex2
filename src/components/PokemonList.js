...
import SortBtn from "../assets/Sort_Button.png";
        ...
        data.map(async (pokemon) => {
          try {
            ...
            const details = res.data;
             ...
             // Console data
             console.log(details, "detail pokemons");
...
console.log(filteredPokemons,"filter pokemons");
  ...
  return (
    ...
    >
      <div className="header">
        ...
        <img src={pokeball} alt="Pokemon Logo" className="poke_logo" />
        <h1 className="top_heading">Pokédex</h1>
      </div>
      <br />
      <div className="first-container">
        ...
        <div className="Sort" onClick={toggleTheme}>
          {/* <img src={SortBtn} alt="Sort Logo" className="sort-logo" /> */}
          <div>
            <p>#</p>
          </div>
        </div>
